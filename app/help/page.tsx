        ...
        <div className="text-pretty">
          ...
          <Section id="helpful" title="参考になった・公開プロフィール">
            <Faq q="「参考になった」を押すとどうなりますか？">
              押した数がレビュー投稿者の「レビュー貢献度」として、投稿者の公開プロフィールに累計表示されます。1つのレビューにつき1人1回までで、もう一度押すと取り消せます。自分自身のレビューには押せません。
            </Faq>
            <Faq q="「シナリオ以外の要因が大きそう」とは何ですか？">
              レビューの評価が、シナリオそのものよりKP・卓の雰囲気・参加者・プレイ状況といった要因による可能性がある、と感じたときに使うボタンです。「参考になった」や通報とは完全に別の集計で、レビューの削除や評価、レビュー貢献度には一切影響しません。あくまで読み手への参考情報です。
            </Faq>
            <Faq q="公開プロフィール（/u/...）には何が表示されますか？">
              アイコン・表示名・自己紹介・好きな傾向タグ・レビュー貢献度（累計の参考になった数）・お気に入りに登録したシナリオが表示されます。個別のレビュー本文はメインには表示されず、「レビューを見る」から新着順・参考になった順で一覧を確認できます。
            </Faq>
